...
| AJ-03 | UNPROVEN | Malformed carrier, stale base, protected handoff, Thread Engine self-change handoff, and generated/source mixing are proven without mutation. Exact live no-mutation proofs remain missing for non-owner, edited input, replay, duplicate branch, and duplicate PR. |
