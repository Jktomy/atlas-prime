...
The R04 audit found PR #189 open, draft, stale, and conflicting; its final patch
also included an unrelated M02 correction and formatting churn outside the
M06-only transaction boundary. It was preserved unmerged and not reused. PR
#190 remains the known-bad partial negative case and must never merge. This
clean replacement starts from exact canonical main
`91f4392880b7a76f675c933aa429e9f10d1c740e` and changes only the M06
acceptance surfaces.
