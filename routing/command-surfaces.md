...
| Athena execution-route parity and hosted identity | `governance/athena-execution-route-contract.md`, `governance/athena-fresh-work-origin-contract.md`, `schemas/athena-hosted-route-request-v1.schema.json`, `schemas/athena-hosted-route-receipt-v1.schema.json`, `tools/athena_routes/README.md` |
...
| Fresh Work/Athena origin construction | `governance/athena-fresh-work-origin-contract.md`, `tools.athena_routes.fresh_work_bridge`, `schemas/athena-fresh-work-origin-receipt-v1.schema.json`, `schemas/athena-fresh-work-journey-receipt-v1.schema.json`; current source can produce only a read-only non-executable binding plan or a no-verifier blocked receipt, has no guided Execute or workflow-dispatch path, and does not prove CAP-015 or AJ-01 |
