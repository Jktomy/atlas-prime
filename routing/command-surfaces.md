...
| Mandatory Open Sky autonomy, proportional safety, simplicity, efficiency, and every-full-Strikeforce Aegis review | `governance/open-sky-doctrine.md`, then `governance/atlas-aegis.md` and `governance/atlas-strikeforce.md` |
