...
| Fresh Work/Athena origin bridge construction | `governance/athena-fresh-work-origin-contract.md`, `tools.athena_routes.fresh_work_bridge`, `schemas/athena-fresh-work-origin-receipt-v1.schema.json`, `schemas/athena-fresh-work-journey-receipt-v1.schema.json`; the bridge wraps the existing guided publisher, requires an independently injected platform verifier, and fails closed without one; construction does not prove CAP-015 or AJ-01 |
