...
| Deterministic conservation and generated projections | `governance/deterministic-conservation-contract.md`, `.github/workflows/generated-checkpoint-publisher.yml`, `tools/generated_checkpoint/README.md`; hosted publication is disabled-first, the workflow is an explicit owner-only read-only freshness check, and stale outputs are rebuilt locally through an ordinary reviewed draft PR |
