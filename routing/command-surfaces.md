...
| Active Quests and admitted Quest parents | `continuity/mission-board-quest-registry-r01.json`, live parent Issues `#307`–`#309` and `#328`, then `quests/`; `quest-board/quest-board-v1.json` is frozen predecessor evidence only |
