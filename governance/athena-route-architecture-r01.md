...
wields an exact Sword without Thread Engine. Spear is Athena's Thread Engine
...
authority. Its construction-only files are removed from current source and
remain available through Git history as historical evidence.
