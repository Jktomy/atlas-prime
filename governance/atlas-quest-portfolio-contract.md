...
- before a later-Quest admission merge, its prepared parent Issue is
  non-authoritative and the current portable registry remains authoritative;
- in the exact candidate tree, the Quest source, one new registry row,
  continuity binding, routing, tests, and recovery update together;
- after exact merged-main readback, the parent Issue becomes the primary live
