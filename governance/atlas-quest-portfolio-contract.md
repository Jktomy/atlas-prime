...
private_boundary: "Public-clean ownership, dependency, and gate state only. Protected evidence and runtime facts remain in their approved systems."
---
...
|---|---|---|
| Prime Ascendant | governed Atlas application and intelligence architecture | Artemis / Operation Harmony, with named Codex Operations for source, memory, Phoenix, and Glass Codex |
