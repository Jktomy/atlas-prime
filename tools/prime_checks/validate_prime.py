...
REQUIRED = (
    ...
    "schemas/investiture-event-v1.schema.json",
    "schemas/investiture-ledger-manifest-v1.schema.json",
    "schemas/investiture-ledger-record-v1.schema.json",
    "schemas/investiture-operation-receipt-v1.schema.json",
    "schemas/investiture-summary-v1.schema.json",
    "schemas/investiture-construction-acceptance-v1.schema.json",
    "tools/investiture_accounting/README.md",
    "tools/investiture_accounting/__init__.py",
    "tools/investiture_accounting/__main__.py",
    "tools/investiture_accounting/core.py",
    "tools/investiture_accounting/storage.py",
    "tools/investiture_accounting/cli.py",
