...
from .core import PreparationError, build_hash_register, prepare_package, reconcile_registers
...
def main(argv: list[str] | None = None) -> int:
    ...
    prepare.add_argument("--replay-nonce", required=True)
    prepare.add_argument("--public-clean-confirmation", required=True)
