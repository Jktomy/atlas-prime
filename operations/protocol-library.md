...
- **Shardblade** is the bounded permanence executor for one exact Jayson-approved candidate or campaign warrant. READY and MERGE remain separate exact-candidate actions; neither may author, repair, widen, or imply the other. Strikeforce GREEN establishes readiness but creates no authority. A campaign stage requires its own child request, exact-head checks, fresh post-READY readback, receipts, rollback, and campaign-expiry enforcement.
