...
class RpC07AcceptanceTests(unittest.TestCase):
    ...
    def test_later_reconciliations_advance_aj01_and_aj03_separately(self) -> None:
    ...
    def test_contract_publishes_current_matrix_and_history_boundary(self) -> None:
        ...
        for line in ("AJ-01 PROVEN", "AJ-02 PROVEN", "AJ-03 PROVEN", "AJ-11 UNPROVEN", "AJ-12 UNPROVEN"):
