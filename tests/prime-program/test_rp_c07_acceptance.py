...
class RpC07AcceptanceTests(unittest.TestCase):
    ...
    def test_later_reconciliations_advance_open_journeys_separately(self) -> None:
    ...
    def test_contract_publishes_current_matrix_and_history_boundary(self) -> None:
        ...
        for line in ("AJ-01 PROVEN", "AJ-02 PROVEN", "AJ-03 PROVEN", "AJ-11 PROVEN", "AJ-12 PROVEN"):
            self.assertIn(line, contract)
        self.assertIn("CAP-027 RESTORED / ACTIVE", contract)
        ...
        self.assertIn("controlling transition for CAP-027 only", contract)
