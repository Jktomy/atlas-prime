...
class CapabilityParityTests(unittest.TestCase):
    ...
    def test_cap022_and_cap027_are_restored_with_no_missing_set(self) -> None:
        ...
        self.assertEqual(cap027["audit_status"], "RESTORED_END_TO_END_ACCEPTANCE_LAYER_PROVEN")
        self.assertEqual(cap027["audit_severity"], "GREEN")
        self.assertIn("All AJ-01 through AJ-12 are PROVEN", cap027["current_state"])
