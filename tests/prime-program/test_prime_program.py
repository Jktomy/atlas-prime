...
class PrimeProgramTests(unittest.TestCase):
    ...
    def test_repairing_prime_is_admitted_without_changing_independent_quests(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                {
                    "next_gate": "CAP-027 final reconciliation permanence and generated-current readback, then whole-Quest Strikeforce",
                    "owner": "Codex / Source Governance",
                    "quest_id": "QUEST-REPAIRING-PRIME-R01",
                    "readiness_basis": (
                        "AJ-01 through AJ-12 are PROVEN. CAP-027 is proposed RESTORED and ACTIVE by the "
                        "separately authorized final capability reconciliation at base "
                        "887c562f40c1ae6756054b322a08b113f6ce60ca, bringing the frozen 28-capability "
                        "register to 15 RESTORED and 0 STILL_MISSING. Exact-head Ubuntu and Windows validation, "
                        "detached review, separate ready and merge authorization, post-merge generated-current "
                        "readback, whole-Quest Strikeforce, closeout, Phoenix recovery, and restart-safe Sunset "
                        "remain open."
                    ),
