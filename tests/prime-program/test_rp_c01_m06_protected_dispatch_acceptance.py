...
class RpC01M06ProtectedDispatchAcceptanceTests(unittest.TestCase):
    ...
    def test_clean_replacement_is_bound_to_exact_current_main(self) -> None:
        ...
        self.assertEqual(
            self.acceptance["transaction_base_sha"],
        ...
        self.assertEqual(
            reconciliation["audited_prior_head_sha"],
            "b68e3cf33d5b01a95e126189a6d06358c4ee6676",
        )
        self.assertEqual(
            reconciliation["known_bad_partial_head_sha"],
            "4a925ef2dfeb3fa461fd4b64e46b8da2242de032",
        )
    ...
    def test_live_receipt_binds_exact_protected_route_and_operator(self) -> None:
        ...
        self.assertEqual(
            bindings["declared_protected_paths"],
    ...
    def test_live_pr_validation_merge_and_canonical_readback_are_exact(self) -> None:
        ...
        self.assertEqual(
            live_pr["exact_head_ci"],
            {
                "run": 29333971422,
                "windows_job": 87088522381,
                "ubuntu_job": 87088522424,
                "result": "GREEN",
            },
        )
        ...
        self.assertEqual(
            ...
            "sha256:b88ddf192094548d522de5c8d92050e24173803861b4c9142670d75253ed3089",
        )
        self.assertEqual(
            generated["exact_head_ci"],
            {
                "run": 29334688393,
                "windows_job": 87091201859,
                "ubuntu_job": 87091201983,
                "result": "GREEN",
            },
        )
    ...
    def test_continuity_preserves_m06_and_advances_through_aj12(self) -> None:
        repairing = next(
        ...
        self.assertEqual(self.continuity["source_base_sha"], "043648a85cf581d7805355a71cc819fdb83e738b")
        for event in (m06_event, m07_event, aj11_event, aj12_event):
        ...
        self.assertLess(self.continuity["event_ids"].index(aj11_event), self.continuity["event_ids"].index(aj12_event))
