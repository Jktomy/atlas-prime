...
class RpC01M06ProtectedDispatchAcceptanceTests(unittest.TestCase):
    ...
    def test_continuity_preserves_m06_and_advances_to_sunset(self) -> None:
        repairing = next(
        ...
        for event in (m06_event, m07_event, aj11_event, aj12_event, cap027_event, strikeforce_event, recovery_event):
