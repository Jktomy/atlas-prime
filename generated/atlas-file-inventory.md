...
| `proof/prometheus-fire/pf-c01-m01-mission-seal-r01.md` | proof | yes | policy-reference |
...
| `proof/repairing-prime/rp-c01-m07-non-owner-acceptance-r01.md` | proof | yes | none |
...
| `proof/repairing-prime/rp-c01-m08-partial-reconciliation-r01.md` | proof | no | none |
...
| `proof/repairing-prime/rp-c08-aj10-cap022-acceptance-reconciliation-r04.md` | proof | no | none |
| `proof/repairing-prime/rp-c08-aj10-cap022-live-acceptance-r03.md` | proof | no | none |
| `proof/repairing-prime/rp-c08-aj11-clean-clone-acceptance-r08.md` | proof | no | none |
| `proof/repairing-prime/rp-c08-aj12-merged-main-validation-acceptance-r01.md` | proof | no | none |
...
| `tools/agentic_warrants/README.md` | tools | no | none |
