...
| `proof/found-silverlight/fs-c01-m02-m03-construction-acceptance-r01.md` | missing | missing | missing | missing |
...
| `proof/repairing-prime/rp-c01-m05-parity-acceptance-r01.md` | PROVEN | PROOF | missing | MEDIUM |
...
| `proof/repairing-prime/rp-c08-aj12-merged-main-validation-acceptance-r01.md` | missing | missing | missing | missing |
...
| `quests/prime-ascendant-covenant.md` | Active | Covenant | missing | High |
...
| `tools/thread-engine/tests/production-adapter-contract.md` | missing | missing | missing | missing |
| `tools/thread-engine/tests/spear-bridge-contract.md` | missing | missing | missing | missing |
| `tools/thread-engine/tests/test-contract.md` | missing | missing | missing | missing |
