...
| `governance/deterministic-conservation-contract.md` | yes |
| `governance/investiture-accounting-contract.md` | yes |
...
| `governance/shard-doctrine.md` | yes |
...
| `lifecycle/architecture-decision-r02.md` | no |
| `lifecycle/lifecycle-construction-contract.md` | no |
| `lifecycle/lifecycle-contract.md` | yes |
| `lifecycle/lifecycle-event-contract.md` | no |
...
| `migration/rollback-map.md` | yes |
| `operations/artemis-runtime-and-routing.md` | yes |
| `operations/operation-registry.md` | yes |
| `operations/protocol-library.md` | yes |
| `projects/project-registry.md` | yes |
| `proof/found-silverlight/fs-c01-m02-m03-construction-acceptance-r01.md` | no |
| `proof/lifecycle/g3-d-beu-reduction-pilot-r01.md` | no |
...
| `proof/repairing-prime/rp-c01-m05-parity-acceptance-r01.md` | no |
| `proof/repairing-prime/rp-c01-m05-parity-live-r01.md` | no |
| `proof/repairing-prime/rp-c01-m06-protected-dispatch-acceptance-r01.md` | no |
| `proof/repairing-prime/rp-c01-m07-live-rejection-reconciliation-r01.md` | no |
| `proof/repairing-prime/rp-c01-m07-non-owner-acceptance-r01.md` | no |
| `proof/repairing-prime/rp-c01-m08-free-form-acceptance-r01.md` | no |
| `proof/repairing-prime/rp-c01-m08-free-form-live-payload-r01.md` | no |
...
| `proof/repairing-prime/rp-c08-aj10-cap022-acceptance-reconciliation-r04.md` | no |
| `proof/repairing-prime/rp-c08-aj10-cap022-live-acceptance-r03.md` | no |
| `proof/repairing-prime/rp-c08-aj11-clean-clone-acceptance-r08.md` | no |
| `proof/repairing-prime/rp-c08-aj12-merged-main-validation-acceptance-r01.md` | no |
...
| `proof/repairing-prime/rp-c08-cap027-final-capability-reconciliation-r01.md` | no |
...
| `templates/protocol-template.md` | yes |
| `templates/source-file-template.md` | yes |
| `templates/support-file-template.md` | yes |
| `tools/agentic_warrants/README.md` | no |
| `tools/athena_routes/README.md` | yes |
...
| `tools/thread-engine/tests/production-adapter-contract.md` | no |
| `tools/thread-engine/tests/spear-bridge-contract.md` | no |
| `tools/thread-engine/tests/test-contract.md` | no |
