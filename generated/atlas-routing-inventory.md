...
| `governance/repository-process-contract.md` | yes |
...
| `lifecycle/architecture-decision-r03.md` | no |
...
| `proof/repairing-prime/rp-c08-final-repairing-prime-completion-r05.md` | no |
| `proof/repairing-prime/rp-c08-final-whole-quest-strikeforce-reconciliation-r01.md` | no |
| `proof/repairing-prime/rp-c08-living-emberline-repair-r01.md` | no |
| `proof/repairing-prime/rp-c08-phoenix-recovery-acceptance-r01.md` | no |
...
| `quests/prime-ascendant-covenant.md` | no |
| `quests/prime-ascendant.md` | yes |
| `quests/prime-continuity-proof.md` | yes |
| `quests/prime-reborn.md` | yes |
| `quests/prometheus-fire.md` | yes |
| `quests/repairing-prime.md` | yes |
| `recovery/elantris-recovery.md` | yes |
| `recovery/phoenix-recovery.md` | no |
...
| `tools/candidate_seal/README.md` | no |
